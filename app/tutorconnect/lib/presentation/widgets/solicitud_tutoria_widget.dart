...
class _SolicitudesTutoriasWidgetState extends ConsumerState<SolicitudesTutoriasWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    var solicitudes = (state.solicitudes ?? []).where((solicitud) {
      print("Comparando currentUser: ${currentUser?.id} con solicitud.estudianteId: ${solicitud.estudianteId}");
      return (currentUser?.id == solicitud.estudianteId);
    }).toList();

    print("Solicitudes después de filtrar permisos: ${solicitudes.length}");
    ...
    if (filtroFecha != null) {
      ...
      solicitudes = solicitudes.where((s) {
       ...
       print("Solicitudes después de filtrar por rango de fechas: ${solicitudes.length}");
    }
